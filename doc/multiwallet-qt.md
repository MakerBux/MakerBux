...
In order to support loading of multiple wallets in MakerBux-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is MakerBux.cpp.
...
Changes to MakerBux.cpp
----------------------
MakerBux.cpp is the entry point into MakerBux-qt, and as such, will require some minor modifications to provide hooks for
