...
This mechanism has been integrated into Bitcore-Node-MakerBux which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/MakerBux-Project/insight-api-MakerBux#web-socket-api](https://github.com/MakerBux-Project/insight-api-MakerBux#web-socket-api) 
* API: [https://github.com/MakerBux-Project/insight-api-MakerBux#swifttx-transactions](https://github.com/MakerBux-Project/insight-api-MakerBux#swifttx-transactions) 
...
By default, the MakerBux Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MakerBux Core daemon:
