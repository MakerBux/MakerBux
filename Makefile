...
pkgdatadir = $(datadir)/MakerBux
pkgincludedir = $(includedir)/MakerBux
pkglibdir = $(libdir)/MakerBux
pkglibexecdir = $(libexecdir)/MakerBux
...
CONFIG_HEADER = $(top_builddir)/src/config/MakerBux-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/MakerBux-config.h.in \
...
ACLOCAL = ${SHELL} /home/lev/Documents/lp/MakerBux/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/lev/Documents/lp/MakerBux/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/lev/Documents/lp/MakerBux/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/lev/Documents/lp/MakerBux/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/lev/Documents/lp/MakerBux/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = MakerBux
PACKAGE_BUGREPORT = www.MakerBux.com
PACKAGE_NAME = MakerBux Core
PACKAGE_STRING = MakerBux Core 1.0.0
PACKAGE_TARNAME = MakerBux
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/lev/Documents/lp/MakerBux
abs_srcdir = /home/lev/Documents/lp/MakerBux
abs_top_builddir = /home/lev/Documents/lp/MakerBux
abs_top_srcdir = /home/lev/Documents/lp/MakerBux
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/lev/Documents/lp/MakerBux/build-aux/install-sh
...
pdfdir = ${docdir}
prefix = /home/lev/Documents/lp/MakerBux/depends/i686-w64-mingw32
...
SUBDIRS = src
BITCOIND_BIN = $(top_builddir)/src/MakerBuxd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/MakerBux-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/MakerBux-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = MakerBux-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_MakerBux_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_MakerBux_coverage.info test_MakerBux.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/MakerBux-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/MakerBux-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/MakerBux-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/MakerBux-config.h
$(top_srcdir)/src/config/MakerBux-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/MakerBux-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/MakerBux-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MakerBux-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MakerBux-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_MakerBux.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_MakerBux -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_MakerBux_filtered.info: test_MakerBux.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_MakerBux_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_MakerBux_coverage.info: baseline_filtered_combined.info test_MakerBux_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_MakerBux_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_MakerBux_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_MakerBux_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_MakerBux.coverage/.dirstamp:  test_MakerBux_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_MakerBux.coverage/.dirstamp total.coverage/.dirstamp

# MakerBux: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_MakerBux.coverage/ total.coverage/ $(OSX_APP)
