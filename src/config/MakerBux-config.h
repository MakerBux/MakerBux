/* src/config/MakerBux-config.h.  Generated from MakerBux-config.h.in by configure.  */
/* src/config/MakerBux-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MKRBX_CONFIG_H

#define MKRBX_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.MakerBux.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MakerBux Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MakerBux Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "MakerBux"
