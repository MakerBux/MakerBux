...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MakerBux Core MakerBux-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  MakerBux-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MakerBux transaction") + "\n" +
                               "  MakerBux-tx [options] -create [commands]   " + _("Create hex-encoded MakerBux transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded MakerBux transaction
