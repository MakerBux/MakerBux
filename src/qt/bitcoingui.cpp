                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MakerBux Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MakerBux address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and MakerBux: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MakerBux Core"), this);
    aboutAction->setStatusTip(tr("Show information about MakerBux Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MakerBux"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MakerBux addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MakerBux addresses"));
    ...
    openAction->setStatusTip(tr("Open a MakerBux: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MakerBux Core help message to get a list with possible MakerBux command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MakerBux Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MakerBux network", "", count));
}
...
{
    QString strTitle = tr("MakerBux Core"); // default title
