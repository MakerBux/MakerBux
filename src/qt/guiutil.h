...
/** Utility functions used by the MakerBux Qt UI.
 */
namespace GUIUtil
{
...
// Render MakerBux addresses in monospace font
...
// Parse "MakerBux:" URI into recipient object, return true on successful parsing
