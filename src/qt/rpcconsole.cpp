                                          ...
                                          cachedNodeid(-1)
{
    ...
    ui->wallet_path->setText(QString::fromStdString(GetDataDir().string() + QDir::separator().toLatin1() + GetArg("-wallet", "makerbux.dat")));
#else
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MakerBux RPC console.") + "<br>" +
