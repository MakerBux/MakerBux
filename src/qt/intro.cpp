...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MakerBux Core"),
     ...
     * override -datadir in the MakerBux.conf file in the default data directory
     * (to be consistent with MakerBuxd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
