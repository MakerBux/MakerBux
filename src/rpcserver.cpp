...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MakerBux server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MakerBux server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MakerBux features */
        {"MakerBux", "masternode", &masternode, true, true, false},
        {"MakerBux", "listmasternodes", &listmasternodes, true, true, false},
        {"MakerBux", "getmasternodecount", &getmasternodecount, true, true, false},
        {"MakerBux", "masternodeconnect", &masternodeconnect, true, true, false},
        {"MakerBux", "masternodecurrent", &masternodecurrent, true, true, false},
        {"MakerBux", "masternodedebug", &masternodedebug, true, true, false},
        {"MakerBux", "startmasternode", &startmasternode, true, true, false},
        {"MakerBux", "createmasternodekey", &createmasternodekey, true, true, false},
        {"MakerBux", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"MakerBux", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"MakerBux", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"MakerBux", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"MakerBux", "getmasternodescores", &getmasternodescores, true, true, false},
        {"MakerBux", "mnbudget", &mnbudget, true, true, false},
        {"MakerBux", "preparebudget", &preparebudget, true, true, false},
        {"MakerBux", "submitbudget", &submitbudget, true, true, false},
        {"MakerBux", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"MakerBux", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"MakerBux", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"MakerBux", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"MakerBux", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"MakerBux", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"MakerBux", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"MakerBux", "checkbudgets", &checkbudgets, true, true, false},
        {"MakerBux", "mnsync", &mnsync, true, true, false},
        {"MakerBux", "spork", &spork, true, true, false},
        {"MakerBux", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"MakerBux", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use MakerBuxd, or the -server option to MakerBux-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> MakerBux-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22268/\n";
}
