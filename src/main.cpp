...
#if defined(NDEBUG)
#error "MakerBux cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	else if (nHeight >= 200 && nHeight < 19999) {
        nSubsidy = 3 * COIN;
    }
	else if (nHeight >= 20000 && nHeight < 29999) {
        nSubsidy = 4 * COIN;
    }
	...
	else if (nHeight >= 140000 && nHeight < 1499999) {
        nSubsidy = 25 * COIN;
    }
	else if (nHeight >= 1500000 && nHeight < 1599999) {
        nSubsidy = 24 * COIN;
    }
	else if (nHeight >= 1600000 && nHeight < 1699999) {
        nSubsidy = 23 * COIN;
    }
	else if (nHeight >= 1700000 && nHeight < 1799999) {
        nSubsidy = 22 * COIN;
    }
	else if (nHeight >= 1800000 && nHeight < 1899999) {
        nSubsidy = 21 * COIN;
    }
	else if (nHeight >= 1900000 && nHeight < 1999999) {
        nSubsidy = 20 * COIN;
    }
	else if (nHeight >= 2000000 && nHeight < 2099999) {
        nSubsidy = 19 * COIN;
    }
	else if (nHeight >= 2100000 && nHeight < 2199999) {
        nSubsidy = 18 * COIN;
    }
	else if (nHeight >= 2200000 && nHeight < 2299999) {
        nSubsidy = 17 * COIN;
    }
	else if (nHeight >= 2300000 && nHeight < 2399999) {
        nSubsidy = 16 * COIN;
    }
	else if (nHeight >= 2400000 && nHeight < 2499999) {
        nSubsidy = 15 * COIN;
    }
	else if (nHeight >= 2500000 && nHeight < 2599999) {
        nSubsidy = 14 * COIN;
    }
	else if (nHeight >= 2600000 && nHeight < 2699999) {
        nSubsidy = 13 * COIN;
    }
	else if (nHeight >= 2700000 && nHeight < 2799999) {
        nSubsidy = 12 * COIN;
    }
	else if (nHeight >= 2800000 && nHeight < 2899999) {
        nSubsidy = 11 * COIN;
    }
	else if (nHeight >= 2900000 && nHeight < 2999999) {
        nSubsidy = 10.8 * COIN;
    }
	else if (nHeight >= 3000000 && nHeight < 3099999) {
        nSubsidy = 10.6 * COIN;
    }
	else if (nHeight >= 3100000 && nHeight < 3199999) {
        nSubsidy = 10.4 * COIN;
    }
	else if (nHeight >= 3200000 && nHeight < 3299999) {
        nSubsidy = 10.2 * COIN;
    }
	else if (nHeight >= 3300000 && nHeight < 3399999) {
        nSubsidy = 10 * COIN;
    }
	else if (nHeight >= 3400000 && nHeight < 3499999) {
        nSubsidy = 9.8 * COIN;
    }
	else if (nHeight >= 3500000 && nHeight < 3599999) {
        nSubsidy = 9.6 * COIN;
    }
	else if (nHeight >= 3600000 && nHeight < 3699999) {
        nSubsidy = 9.4 * COIN;
    }
	else if (nHeight >= 3700000 && nHeight < 3799999) {
        nSubsidy = 9.2 * COIN;
    }
	else if (nHeight >= 3800000 && nHeight < 3899999) {
        nSubsidy = 9 * COIN;
    }
	else if (nHeight >= 3900000 && nHeight < 3999999) {
        nSubsidy = 8.8 * COIN;
    }
	else if (nHeight >= 4000000 && nHeight < 4099999) {
        nSubsidy = 8.6 * COIN;
    }
	else if (nHeight >= 4100000 && nHeight < 4199999) {
        nSubsidy = 8.4 * COIN;
    }
	else if (nHeight >= 4200000 && nHeight < 4299999) {
        nSubsidy = 8.2 * COIN;
    }
	else if (nHeight >= 4300000 && nHeight < 4399999) {
        nSubsidy = 8 * COIN;
    }
	else if (nHeight >= 4400000 && nHeight < 4499999) {
        nSubsidy = 7.8 * COIN;
    }
	else if (nHeight >= 4500000 && nHeight < 4599999) {
        nSubsidy = 7.6 * COIN;
    }
	else if (nHeight >= 4600000 && nHeight < 4699999) {
        nSubsidy = 7.4 * COIN;
    }
	else if (nHeight >= 4700000 && nHeight < 4799999) {
        nSubsidy = 7.2 * COIN;
    }
	else if (nHeight >= 4800000 && nHeight < 4899999) {
        nSubsidy = 7 * COIN;
    }
	else if (nHeight >= 4900000 && nHeight < 4999999) {
        nSubsidy = 6.8 * COIN;
    }
	else if (nHeight >= 5000000 && nHeight < 5099999) {
        nSubsidy = 6.6 * COIN;
    }
	else if (nHeight >= 5100000 && nHeight < 5199999) {
        nSubsidy = 6.4 * COIN;
    }
	else if (nHeight >= 5200000 && nHeight < 5299999) {
        nSubsidy = 6.2 * COIN;
    }
	else if (nHeight >= 5300000) {
        nSubsidy = 6 * COIN;
    }
    return nSubsidy;
}
...
{
    RenameThread("MakerBux-scriptch");
